...
class TridentDisplayer:
    ...
    def __init__(self, mainWindow: tk.Tk, frame: tk.Frame | None = None):
        ...
        # Local Variables
        - createTableButton, importTableButton, plotButton, desmosButtonFrame: tk.Button
        '''
    ...
    def exportEquationsToDesmosFunc(self):
        cell_names = [self.getValFromCell(i, 0) for i in range(self.numberOfRowsInUse)]
        self.mainWindow.clipboard_append("\n".join([
...
if __name__ == '__main__':
    ...
    tridentDisplayer = TridentDisplayer(window)
    window.mainloop()
